...
function counterFactory(value) {
  ...
  let val=value
  return {
     inc: function (){return ++val} ,
    dec:function (){return --val}
}
}
...
function secretNumber() {
  ...
  return {
    // Code here
    addToSecret: addToSecret=(num)=>{ secret+= num; return secret},
    takeAwayFromSecret: takeAwayFromSecret=(num)=>{ secret-=num; return secret}
  };
}
